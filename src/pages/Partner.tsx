  ...
  return (
    <div className="min-h-screen bg-cream overflow-x-hidden">
      <div className="container mx-auto px-4 py-16">
            ...
            {partners.map((partner, index) => (
              ...
              >
                ...
                <div className="p-5 sm:p-6 text-center">
                  ...
                  {partner.description && (
                    <p className="text-sm text-black-light leading-relaxed mb-4 line-clamp-5" style={{ lineHeight: '1.6' }}>
                      {partner.description}
                    </p>
                  )}
                  {partner.website && (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-7 max-w-3xl mx-auto">
            {minorPartners.map((partner, index) => (
              ...
              >
                ...
                <div className="h-20 sm:h-22 bg-white flex items-center justify-center p-4 sm:p-6">
                  {partner.logo ? (
                    <img
                      src={partner.logo}
                      alt={partner.name}

        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative h-96 rounded-lg overflow-hidden shadow-lg bg-white">
                <img
                  src={import.meta.env.BASE_URL + 'foto_maglia_crinali.jpeg'}
                  alt="Maglia Crinali"
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-8">
              ...
              <div className="bg-sand rounded-lg p-10 border-2 border-sand-dark shadow-xl max-w-md w-full">
                ...
                <button
                  onClick={() => window.open('https://docs.google.com/forms/d/e/1FAIpQLSe0_qKp-2FrnxEYBygzzYbBBF2B0flSKgzyuYB-WKlTURFJHw/viewform?usp=publish-editor', '_blank')}
              ...
              <div className="bg-sand rounded-lg p-10 border-2 border-sand-dark shadow-xl max-w-md w-full">
                ...
                <button
                   onClick={() => window.open('https://docs.google.com/forms/d/e/1FAIpQLSdnr2deWPc7qUHpDH1HzvVYCM8msvyKM-0SVoaPkp72P-ug7w/viewform?usp=publish-editor', '_blank')}
                  className="w-full bg-white text-sand hover:bg-gray-100 px-6 py-4 rounded-lg font-semibold transition-colors text-lg"
                >
                  Iscriviti Ora
                </button>
